          ...
          <div className="product-offer-info">
            ...
            <div className="product-offer-details">
              ...
              <div className="Qty">
                ...
                <button className="__btn-theme btn-theme" onClick={() => incrementQuantity({ articleNumber: product.articleNumber, product: product })} href="#"> ADD TO CART</button>
              </div>
              <div className="Share">
                <h1>Share:</h1>
                <div className="social-media-share">
                  <ExternalLinkIcon className="social-media-icons" link="https://facebook.com" icon="fa-brands fa-facebook-f" />
                  <ExternalLinkIcon className="social-media-icons" link="https://instagram.com" icon="fa-brands fa-instagram" />
                  <ExternalLinkIcon className="social-media-icons" link="https://twitter.com" icon="fa-brands fa-twitter" />
                  <ExternalLinkIcon className="social-media-icons" link="https://google.com" icon="fa-brands fa-google" />
                  <ExternalLinkIcon className="social-media-icons" link="https://linkedin.com" icon="fa-brands fa-linkedin" />
                </div>
              </div>
            </div>
          </div>
